...
<template>
  <div class="fixed inset-0 z-[999] flex h-screen w-screen flex-col items-center justify-center gap-10 bg-white">
    <h2 v-if="props.error" class="text-3xl text-red-500">An error has occurred</h2>
    <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-primary" viewBox="0 0 24 24">
      <g>
